...
public class NC_User_01_Register_Grid_I_BrowserStack extends BaseTest {
    ...
    @Parameters({"browser", "browserURL", "browser_version", "os", "os_version"})
    @BeforeClass
    public void beforeClass(String browserName, String envName, String browserVersion, String osName, String osVersion) {
    	ConfigFactory.setProperty("env", envName);
    	environment = ConfigFactory.create(Environments.class);
        driver = getBrowserDriverBrowserStack(browserName, environment.getAppURL(), browserVersion, osName, osVersion);
